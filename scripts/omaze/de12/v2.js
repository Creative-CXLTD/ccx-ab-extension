(function () {
  ...
  const SELECTORS = {
    CONTROL_HOME_BANNER_CONTROLS: '.home--banner .banner-controls',
    CONTROL_MOBILE_HMA_LAST_H3: '.hero-mobile-addendum > .hma-content > h3:last-of-type',
    CONTROL_MOBILE_IMAGE_TEXT: '.hero-mobile-addendum img + p',
    CONTROL_DESKTOP_HERO_CTA_CONTAINER: '.campaign-hero__content > .campaign-hero__subtitle + div',
    CONTROL_MOBILE_CHECK_ODDS: '.ccx-checkodds-wrapper--mobile'
  };
  ...
  const CONTROL_ODDS_ICON_TROPHY_WHITE = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.5 10.995V12.2145C7.49424 12.7371 7.21692 13.219 6.768 13.4865C5.81779 14.1903 5.25518 15.301 5.25 16.4835M10.5 10.995V12.2145C10.5058 12.7371 10.7831 13.219 11.232 13.4865C12.1822 14.1903 12.7448 15.301 12.75 16.4835M13.5 6.75H14.625C15.6598 6.75 16.5 5.90984 16.5 4.875C16.5 3.84016 15.6598 3 14.625 3H13.5M3 16.5H15" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4.5 6.75C4.5 9.23362 6.51638 11.25 9 11.25C11.4836 11.25 13.5 9.23362 13.5 6.75V2.25C13.5 1.83606 13.1639 1.5 12.75 1.5H5.25C4.83606 1.5 4.5 1.83606 4.5 2.25V6.75M4.5 6.75H3.375C2.34016 6.75 1.5 5.90984 1.5 4.875C1.5 3.84016 2.34016 3 3.375 3H4.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;

  const ICON_TROPHY_BLUE = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.5 10.995V12.2145C7.49424 12.7371 7.21692 13.219 6.768 13.4865C5.81779 14.1903 5.25518 15.301 5.25 16.4835M10.5 10.995V12.2145C10.5058 12.7371 10.7831 13.219 11.232 13.4865C12.1822 14.1903 12.7448 15.301 12.75 16.4835M13.5 6.75H14.625C15.6598 6.75 16.5 5.90984 16.5 4.875C16.5 3.84016 15.6598 3 14.625 3H13.5M3 16.5H15" stroke="#0090B1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4.5 6.75C4.5 9.23362 6.51638 11.25 9 11.25C11.4836 11.25 13.5 9.23362 13.5 6.75V2.25C13.5 1.83606 13.1639 1.5 12.75 1.5H5.25C4.83606 1.5 4.5 1.83606 4.5 2.25V6.75M4.5 6.75H3.375C2.34016 6.75 1.5 5.90984 1.5 4.875C1.5 3.84016 2.34016 3 3.375 3H4.5" stroke="#0090B1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;

  const CCX_MODAL_BG_IMAGE = 'https://cdn-eu.dynamicyield.com/api/9881146/images/674bfa83b221.png';

  const ICON_INFORMATION_MODAL = `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.6665 10.0001C1.6665 14.5994 5.40055 18.3334 9.99984 18.3334C14.5991 18.3334 18.3332 14.5994 18.3332 10.0001C18.3332 5.40079 14.5991 1.66675 9.99984 1.66675C5.40055 1.66675 1.6665 5.40079 1.6665 10.0001V10.0001" stroke="#081F28" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
...
`;
  ...
  const ICON_MODAL_CARD_PACKET = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
  ...
  const CONTROL_MOBILE_TICKET_ICON = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1.5 6.75C2.74181 6.75 3.75 7.75819 3.75 9C3.75 10.2418 2.74181 11.25 1.5 11.25V12.75C1.5 13.5779 2.17213 14.25 3 14.25H15C15.8279 14.25 16.5 13.5779 16.5 12.75V11.25C15.2582 11.25 14.25 10.2418 14.25 9C14.25 7.75819 15.2582 6.75 16.5 6.75V5.25C16.5 4.42213 15.8279 3.75 15 3.75H3C2.17213 3.75 1.5 4.42213 1.5 5.25V6.75M9.75 3.75V5.25M9.75 12.75V14.25M9.75 8.25V9.75" stroke="#626262" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;

  const ICON_TROPHY_2 = `<svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M5.31067 1.83283C5.26283 1.87717 5.25 1.92033 5.25 1.95183V8.41283C5.25 10.0462 5.70033 11.4462 6.5135 12.4227C7.31033 13.377 8.51433 14 10.2083 14C11.9023 14 13.1063 13.377 13.9032 12.4227C14.7163 11.4473 15.1667 10.0462 15.1667 8.41283V1.95183C15.1667 1.92033 15.155 1.87717 15.106 1.83283C15.0415 1.77825 14.9595 1.74883 14.875 1.75H5.54167C5.45719 1.74883 5.37515 1.77825 5.31067 1.83283ZM3.5 1.95183C3.5 0.8085 4.48117 0 5.54167 0H14.875C15.9355 0 16.9167 0.809666 16.9167 1.95183V2.33333H18.375C19.502 2.33333 20.4167 3.248 20.4167 4.375V6.70833C20.4167 8.93433 18.6352 10.6995 16.5585 11.0285C16.2975 11.9472 15.8512 12.8028 15.2472 13.5427C14.252 14.735 12.8438 15.512 11.0833 15.7033V18.6667H13.7083C13.9404 18.6667 14.163 18.7589 14.327 18.9229C14.4911 19.087 14.5833 19.3096 14.5833 19.5417C14.5833 19.7737 14.4911 19.9963 14.327 20.1604C14.163 20.3245 13.9404 20.4167 13.7083 20.4167H6.70833C6.47627 20.4167 6.25371 20.3245 6.08961 20.1604C5.92552 19.9963 5.83333 19.7737 5.83333 19.5417C5.83333 19.3096 5.92552 19.087 6.08961 18.9229C6.25371 18.7589 6.47627 18.6667 6.70833 18.6667H9.33333V15.7033C7.57283 15.5108 6.16467 14.735 5.1695 13.5427C4.56545 12.8028 4.11918 11.9472 3.85817 11.0285C1.7815 10.6983 0 8.93433 0 6.70833V4.375C0 3.248 0.914667 2.33333 2.04167 2.33333H3.5V1.95183ZM3.5 4.08333H2.04167C1.96431 4.08333 1.89012 4.11406 1.83543 4.16876C1.78073 4.22346 1.75 4.29764 1.75 4.375V6.70833C1.75 7.77 2.50133 8.736 3.52567 9.13733C3.5088 8.89659 3.50024 8.65533 3.5 8.414V4.08333ZM16.891 9.13733C17.9153 8.736 18.6667 7.77 18.6667 6.70833V4.375C18.6667 4.29764 18.6359 4.22346 18.5812 4.16876C18.5265 4.11406 18.4524 4.08333 18.375 4.08333H16.9167V8.41283C16.9167 8.65628 16.9081 8.89778 16.891 9.13733Z" fill="white"/> </svg>`;
...
/* ===============================
   CHECK ODDS COMPONENT
=============================== */
.ccx-checkodds-wrapper {
  display: flex;
  justify-content: center;
  align-items: center;
  margin-top: 16px;
...
.ccx-checkodds-wrapper--mobile {
  display: flex;
}

.ccx-checkodds.ccx-checkodds--mobile {
  height: 42px;
  margin-bottom: 1rem;
  opacity: 1;
  gap: 8px;
...
.ccx-checkodds-wrapper--desktop {
  display: none;
}

.ccx-checkodds.ccx-checkodds--desktop {
  height: 36px;
  opacity: 1;
  gap: 8px;
  padding-top: 9px;
...
/* At 768px and above: switch to desktop only */
...
/* ===============================
   GUARANTEED WINNERS COMPONENT
=============================== */
.ccx-guaranteed-winners {
  display: flex;
  align-items: center;
  gap: 8px;
  margin-top: 12px;
...
.ccx-guaranteed-winners--mobile {
  ...
  .ccx-guaranteed-winners--mobile .ccx-guaranteed-winners__text {
    font-family: Gellix;
    font-weight: 700;
    font-size: 14px;
  }
.ccx-guaranteed-winners__icon {
  display: flex;
  align-items: center;
  justify-content: center;
}
...
.ccx-guaranteed-winners--desktop {
  display: none;
}
...
/* Modal layout */
.ccx-winningchance-container {
  display: flex;
  flex-direction: column;
  height: 100%;
}

.ccx-winningchance-top {
  flex: 0 0 auto;
  border: 1px solid #F5F5F5;
  height: 81px;
  border-width: 1px;
...
.ccx-winningchance-summary span {
  color: #081F28;
  font-family: Gellix;
  font-weight: 700;
  font-size: 14px;
...
.ccx-winningchance-note::before {
  content: "";
  position: absolute;
  inset: 0;
  background: url(https://cdn-eu.dynamicyield.com/api/9881146/images/674bfa83b221.png)
...
/* Scrollbar */
.ccx-winningchance-middle::-webkit-scrollbar {
  width: 6px;
}
.ccx-winningchance-middle::-webkit-scrollbar-thumb {
  background: #ccc;
  border-radius: 3px;
}
...
@media (min-width: 768px) {
  ...
  const addBodyClass = (bodyClass) => {
    ...
    if (!document.querySelector('.' + bodyClass)) {
      ...
      console.log('[init] Added class ' + bodyClass + ' to body');
    }
  }
  ...
  function createCCXSlider(CONTROL_MOBILE_HMA_LAST_H3, SLIDE_DATA, ARROW_LEFT, ARROW_RIGHT, TRUST_PILOT_HTML) {
    if (!CONTROL_MOBILE_HMA_LAST_H3) return;
  ...
  `;
    ...
    CONTROL_MOBILE_HMA_LAST_H3.insertAdjacentElement('afterend', wrapper);
  ...
  const handleSlideshowPosition = (CONTROL_MOBILE_HMA_LAST_H3) => {
    ...
    if (!slideshowWrapper) {
      console.log('[handleSlideshowPosition] Slideshow wrapper not found');
      return;
    }
    ...
    if (screenWidth >= 992) {
      ...
      if (heroContent && heroContent.lastElementChild !== slideshowWrapper) {
        console.log('[handleSlideshowPosition] Moving slideshow inside #hero-video > .campaign-hero__content (desktop)');
      ...
      if (hmaHeading && hmaHeading.nextElementSibling !== slideshowWrapper) {
        console.log('[handleSlideshowPosition] Moving slideshow after HMA heading (mobile)');
  ...
  // ===============================
  // CREATE CHECK ODDS COMPONENT
  // ===============================
  function createCheckOddsComponent(oddsValue, variant) {
    // oddsValue: "225K", variant: "mobile" | "desktop"
    const iconHTML = variant === 'mobile' ? ICON_TROPHY_BLUE : CONTROL_ODDS_ICON_TROPHY_WHITE;

    const componentHTML =
      '<div class="ccx-checkodds ccx-checkodds--' + variant + '">' +
      '<div class="ccx-checkodds__icon">' +
      iconHTML +
      '</div>' +
    ...
    const wrapper = document.createElement('div');
    wrapper.className = 'ccx-checkodds-wrapper ccx-checkodds-wrapper--' + variant;
    wrapper.innerHTML = componentHTML;
    return wrapper;
  }

  // ===============================
  // INSERT COMPONENTS FOR MOBILE + DESKTOP
  // ===============================
  function insertCheckOddsComponents() {
    const SELECTORS = {
      CONTROL_MOBILE_IMAGE_TEXT: '.hero-mobile-addendum img + p',
      CONTROL_DESKTOP_HERO_CTA_CONTAINER: '.campaign-hero__content > .campaign-hero__subtitle + div'
    };
    ...
    if (mobileTarget) {
      mobileTarget.insertAdjacentElement('afterend', mobileComponent);
      console.log('[CheckOdds] Mobile component inserted');
    } else {
      console.warn('[CheckOdds] Mobile target not found:', SELECTORS.CONTROL_MOBILE_IMAGE_TEXT);
    }

    // Insert after desktop element
    const desktopTarget = document.querySelector(SELECTORS.CONTROL_DESKTOP_HERO_CTA_CONTAINER);
    if (desktopTarget) {
      desktopTarget.insertAdjacentElement('afterend', desktopComponent);
      console.log('[CheckOdds] Desktop component inserted');
    } else {
      console.warn('[CheckOdds] Desktop target not found:', SELECTORS.CONTROL_DESKTOP_HERO_CTA_CONTAINER);
    }
  }

  // ===============================
  // CREATE & INSERT GUARANTEED WINNERS ELEMENT
  // ===============================
  function insertGuaranteedWinners() {
    // === Scoped selectors (explicit) ===
    const SELECTORS = {
      MOBILE_CHECK_ODDS: '.ccx-checkodds-wrapper--mobile',
      DESKTOP_BANNER_CONTROLS: '.home--banner .banner-controls'
    };

    // === Helper: Create Element ===
    const createGuaranteedEl = function (variant) {
      const el = document.createElement('div');
      el.className = 'ccx-guaranteed-winners ccx-guaranteed-winners--' + variant;

      el.innerHTML =
        '<div class="ccx-guaranteed-winners__icon">' +
        (variant === 'mobile' ? CONTROL_MOBILE_TICKET_ICON : ICON_TROPHY_2) +
        '</div>' +
        '<div class="ccx-guaranteed-winners__text">1 garantierter Gewinnerin</div>';

      return el;
    };

    // === Insert on mobile (after mobile check odds) ===
    const mobileTarget = document.querySelector(SELECTORS.MOBILE_CHECK_ODDS);
    if (mobileTarget) {
      const mobileEl = createGuaranteedEl('mobile');
      mobileTarget.insertAdjacentElement('afterend', mobileEl);
      console.log('[GuaranteedWinners] Inserted mobile version');
    } else {
      console.warn('[GuaranteedWinners] Mobile check odds target not found');
    }

    // === Insert on desktop (after banner controls) ===
    const desktopTarget = document.querySelector(SELECTORS.DESKTOP_BANNER_CONTROLS);
    if (desktopTarget) {
      const desktopEl = createGuaranteedEl('desktop');
      desktopTarget.insertAdjacentElement('afterend', desktopEl);
      console.log('[GuaranteedWinners] Inserted desktop version');
    } else {
  ...
  function createCCXWinningChanceModal(bgImageUrl) {
    ...
    const existing = document.querySelector('.ccx-winningchance-overlay');
    if (existing) existing.remove();

    // === Overlay ===
    const overlay = document.createElement('div');
    overlay.className = 'ccx-winningchance-overlay';

    // === Modal container ===
    const modal = document.createElement('div');
    modal.className = 'ccx-winningchance-modal';
    modal.style.background = bgImageUrl
      ? '#fff url("' + bgImageUrl + '") center/cover no-repeat'
      : '#fff';

    // === Structured modal layout ===
    modal.innerHTML =
      '<div class="ccx-winningchance-container">' +
      '<div class="ccx-winningchance-top">' +
      '<div class="ccx-winningchance-header">' +
      '<div class="ccx-winningchance-icon">' + ICON_INFORMATION_MODAL + '</div>' +
      '<h2 class="ccx-winningchance-title">Meine Gewinnchance</h2>' +
      '</div>' +
      '</div>' +

      '<div class="ccx-winningchance-middle">' +
      '<p class="ccx-winningchance-subtext">' +
      'Deine Gewinnchance hängt von der Gesamtzahl der verkauften Lospakete ab.' +
      '</p>' +

      '<div class="ccx-winningchance-summary">' +
      '<p>' +
      'Bei der Ziehung des <span>Alpen-Hauses</span> gab es ' +
      '<span>4.5&nbsp;mio Lose</span>. Daraus ergaben sich die folgenden ' +
      'Gewinnwahrscheinlichkeiten:' +
      '</p>' +
      '</div>' +

      '<div class="ccx-winningchance-cards">' +
      '<div class="ccx-card">' +
      '<div class="ccx-card-content__left">' +
      '<span class="ccx-card-icon">' + ICON_MODAL_CARD_PACKET + '</span>' +
      ...
      '<div class="ccx-card-content__left">' +
      '<span class="ccx-card-icon">' + ICON_MODAL_CARD_PACKET + '</span>' +
      '<p class="ccx-card-title">Paket mit 50 Losen</p>' +
      '</div>' +
      '<div class="ccx-card-content__right">' +
      '<p class="ccx-card-odds">1 zu 90K</p>' +
      '</div>' +
      '</div>' +
      ...
      '<div class="ccx-card-content__left">' +
      '<span class="ccx-card-icon">' + ICON_MODAL_CARD_PACKET + '</span>' +
      '<p class="ccx-card-title">Paket mit 70 Losen</p>' +
      '</div>' +
      '<div class="ccx-card-content__right">' +
      '<p class="ccx-card-odds">1 zu 65K</p>' +
      '</div>' +
      '</div>' +
      '</div>' +

      '<p class="ccx-winningchance-note">' +
      ...
      '<div class="ccx-winningchance-bottom">' +
      '<button class="ccx-winningchance-btn">Jetzt mitmachen</button>' +
      '</div>' +
      '</div>';
    ...
    // === Close only when clicking directly on the overlay ===
    ...
    // === Handle "Jetzt mitmachen" click ===
    const jetztBtn = modal.querySelector('.ccx-winningchance-btn');
    jetztBtn.addEventListener('click', () => {
      // Find the first .yellow-btn in either target container
      const targetBtn =
        document.querySelector('.shopify-section .yellow-btn') ||
  ...
  const init = () => {
    try {
      console.log(TEST_ID + ' | ' + VARIATION + ' | ' + TEST_NAME);
      console.log('[init] Current URL: ' + CURRENT_URL);

      waitForElements(
        [
          { selector: SELECTORS.CONTROL_MOBILE_HMA_LAST_H3, count: 1 },
          { selector: SELECTORS.CONTROL_MOBILE_IMAGE_TEXT, count: 1 },
          { selector: SELECTORS.CONTROL_DESKTOP_HERO_CTA_CONTAINER, count: 1 }
        ],
        (results) => {
          // ==========================
          ...
          console.log('[INIT] BODYCLASS:', bodyClass);
          ...
          // Element References
          // ==========================
          const CONTROL_MOBILE_HMA_LAST_H3 = results?.[0]?.elements?.[0];
          if (!CONTROL_MOBILE_HMA_LAST_H3) return;
          ...
          handleSlideshowPosition(CONTROL_MOBILE_HMA_LAST_H3);
          ...
          // ==========================
          // Check Odds Component Insertion
          // ==========================
          insertCheckOddsComponents();

          // ==========================
          // Guranteed Winners Component Insertion
          // ==========================
          insertGuaranteedWinners();

          // ==========================
          // Hero Video Observer
          // ==========================
          const heroVideo = document.querySelector('.home--banner #hero-video');
          const bannerComponent = document.querySelector('.ccx-slider-wrapper');
          const desktopGuaranteed = document.querySelector('.ccx-guaranteed-winners');
          const control_bannerControls = document.querySelector('.banner-controls');

          console.log(desktopGuaranteed);
          console.log(bannerComponent);
          console.log(heroVideo);
          if (heroVideo && bannerComponent && desktopGuaranteed) {
            const toggleBannerVisibility = () => {
              bannerComponent.style.display = heroVideo.classList.contains('active') ? 'flex' : 'none';
              desktopGuaranteed.style.display = heroVideo.classList.contains('active') ? 'flex' : 'none';
              
              if (heroVideo.classList.contains('active')) {
                // desktopGuaranteed.removeAttribute('style');
                // desktopGuaranteed.setAttribute('style', 'display: flex;');
                // desktopGuaranteed.setAttribute('style', 'display: flex;');
                control_bannerControls.style.bottom = '4rem';
              } else {
                // desktopGuaranteed.setAttribute('style', 'display: none;');
          ...
          document.addEventListener('click', (e) => {
            const trigger = e.target.closest('.ccx-checkodds');
            if (trigger) {
              e.preventDefault();
              createCCXWinningChanceModal(CCX_MODAL_BG_IMAGE);
