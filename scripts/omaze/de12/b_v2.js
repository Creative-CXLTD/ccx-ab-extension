(function () {
  ...
  const ASSETS = {
    DESKTOP_ICON_TROPHY_TOP: `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    MOBILE_ICON_TROPHY: `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`
  ...
  const SELECTORS = {
    ...
    CONTROL_HERO_CTA_CONTAINER: '.home--banner .campaign-hero__content  .w-100',
  ...
  const STYLES = `
    ...
    ODDS CONTAINER
    =============================== */
    .ccx-guarantee-container-desktop {
      display: none;
    }

    .ccx-guarantee-container-mobile {
      display: flex;
      flex-flow: column;
      align-items: center;
      gap: 0.5rem;
    ...
    .ccx-guarantee-container-mobile__item.ccx-guarantee-container-mobile__item--trophy {
      display: flex;
      align-items: center;
    ...
    .ccx-guarantee-container-mobile__text {
      color: #626262;
      font-size: 12px;
      font-weight: 600;
    }

    .ccx-guarantee-container-mobile__item.ccx-guarantee-container-mobile__item--info {
      display: flex;
      align-items: center;
      cursor: pointer;
      height: 42px;
    ...
    .ccx-guarantee-container-mobile__item--trophy .ccx-guarantee-container-mobile__text {
      color: #0090B1;
      font-family: Gellix;
      font-weight: 700;
      font-size: 14px;
    ...
    .ccx-guarantee-container-mobile__item--info .ccx-guarantee-container-mobile__text {
    ...
    @media screen and (min-width: 768px) {
      ...
      .ccx-guarantee-container-desktop__item {
        display: flex;
        align-items: center;
        color: white;
        cursor: pointer;
      }
      .ccx-guarantee-container-desktop__text {
        margin-left: 0.5rem;
      }
      .ccx-guarantee-container-desktop__item--trophy .ccx-guarantee-container-desktop__text {
        font-size: 16px;
        letter-spacing: 0;
        font-weight: 700;
      }
      .ccx-guarantee-container-desktop__item--info .ccx-guarantee-container-desktop__text {
        font-weight: 700;
        font-size: 14px;
        color: #FFDD00;
        line-height: 20px;
      ...
      .ccx-odds-container-desktop__item.ccx-odds-container-desktop__item--info {
        width: 245px;
        height: 36px;
        margin: 0 auto;
        opacity: 1;
  ...
  const createMobileGuaranteeContainer = function () {
    var container = document.createElement("div");
    container.className = "ccx-guarantee-container-mobile";

    // First Block
    var first = document.createElement("div");
    first.className = "ccx-guarantee-container-mobile__item ccx-guarantee-container-mobile__item--trophy";
    first.innerHTML =
    ...
    second.className = "ccx-guarantee-container-mobile__item ccx-guarantee-container-mobile__item--info";
    second.innerHTML =
      '<span class="ccx-guarantee-container-mobile__icon">' +
      ASSETS.MODAL_ICON_TICKET +
      '</span>' +
      '<span class="ccx-guarantee-container-mobile__text">1 garantierter Gewinnerin</span>';
  ...
  const createDesktopOddsContainer = () => {
    customLog('[createDesktopOddsContainer]');
    var container = document.createElement("div");
  ...
  const createGuaranteeContainer = function () {
    var container = document.createElement("div");
    container.className = "ccx-guarantee-container-desktop";

    // First Block
    var first = document.createElement("div");
    first.className = "ccx-guarantee-container-desktop__item ccx-guarantee-container-desktop__item--trophy";
    first.innerHTML =
      '<span class="ccx-guarantee-container-desktop__icon">' +
      ASSETS.DESKTOP_ICON_TROPHY +
      '</span>' +
      '<span class="ccx-guarantee-container-desktop__text">1 garantierter Gewinnerin</span>';
  ...
  const initDesktopOddsObserver = (bannerControlsEl) => {
    const desktopOddsContainer = document.querySelector(".ccx-guarantee-container-desktop");
    ...
    try {
      ...
      waitForElements(
        ...
        function (results) {
          ...
          const mobileContainer = createMobileGuaranteeContainer();
          ...
          mobileContainer.querySelector(".ccx-guarantee-container-mobile__item--trophy")
      ...
      waitForElements(
        ...
        function (results) {
          ...
          const desktopContainer = createGuaranteeContainer();
          CONTROL_DESKTOP_BANNER_CONTROLS.insertAdjacentElement("beforeend", desktopContainer);
          customLog("[DESKTOP] Desktop guarantee container inserted", desktopContainer);
          desktopContainer.querySelector(".ccx-guarantee-container-desktop__item--info")
            .addEventListener("click", openOddsModal);
          initDesktopOddsObserver(CONTROL_DESKTOP_BANNER_CONTROLS);
        }
      );
      ...
      waitForElements(
        [
          { selector: SELECTORS.CONTROL_HERO_CTA_CONTAINER, count: 1 },
        ],
        function (results) {
          ...
          const CONTROL_HERO_CTA_CONTAINER = results[0].elements[0];
          if (!CONTROL_HERO_CTA_CONTAINER) return;
          customLog(CONTROL_HERO_CTA_CONTAINER);

          const desktopOddsContainer = createDesktopOddsContainer();
          CONTROL_HERO_CTA_CONTAINER.insertAdjacentElement("afterend", desktopOddsContainer);
          customLog("[DESKTOP] Desktop odds container inserted", desktopOddsContainer);
          desktopOddsContainer.querySelector(".ccx-odds-container-desktop__item")
            .addEventListener("click", openOddsModal);
        }
      );
